export const reactBasicsExamples = [
  ...
  },
  {
    ...
    description: "React components are functions that return JSX.",
  ...
  },
  {
    id: "props",
    name: "Props",
    description: "Props are inputs passed to components.",
  ...
  },
  {
    id: "useState",
    name: "useState",
    description: "useState lets you add local state to functional components.",
  ...
  },
  {
    ...
    name: "useEffect",
    description:
      "useEffect runs side effects after rendering (e.g., data fetching).",
