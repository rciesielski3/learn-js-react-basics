...
import { compositionExamples } from '@/data/react/composition';
...
export default function Composition() {
  ...
  React.useEffect(() => {
    ...
    for (const ex of compositionExamples) {
      try {
        const result = ex.run?.();
    ...
    <div className="flex items-center justify-center min-h-screen p-6 bg-gradient-to-b from-gray-800 to-gray-500">
      <div className="mt-6 p-6 max-w-3xl mx-auto border border-gray-400 bg-gray-700 rounded">
        <SectionHeader
          ...
          description="Compose React UIs by combining smaller components into larger, reusable building blocks."
        />
